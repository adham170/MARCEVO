...
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️│عزيزي المطور ✋🏿\n👨🏻‍🔧│شحن الاشتراك يماكيڤو ما بين يوم الى 1000 يوم فقط 🍃')
end 
return false
end
...
return "📡*│* حدود التكرار ,  يجب ان تماكيڤو ما بين  *[2-50]*" 
end
...
if MsgText[2] and MsgText[2]:match('^%d+$') then
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
if 500 < tonumber(MsgText[2]) then return "📛*│* حدود المسح ,  يجب ان تماكيڤو ما بين  *[2-100]*" end
...
sendMsg(msg.chat_id_,msg.id_,'📛*│* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس ماكيڤو يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n💥')
end  
else
...
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : كـون](t.me/IIIIlIv)',nil,inline,msg.id_)
return false
end
...
return [[
┄─┅══┅─┄     
اهلن بيك ب سورس 𝙈𝘼𝙍𝘾𝙀𝙑𝙊 𝟐𝟎𝟐𝟏 🎄꙳ الاول عل تلي سورس متطور جداً ~ @XXXYYUL
_____________
©® @IIIIlIv
...
elseif Text== "ادهم" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/IIIIlIv")
elseif Text== "المطور" then return sendMsg(msg.chat_id_,msg.id_,"[ مطور سورس ماكيڤو 😍](t.me/IIIIlIv")
...
elseif Text== "بتحبني" then return sendMsg(msg.chat_id_,msg.id_,"بحبك اد الماكيڤو 😍🌷")
...
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](https://t.me/IIIIlIv)
]] )
--=====================================
