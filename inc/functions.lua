...
var = 'مطور اساسي 👨🏻‍✈️' 
elseif redis:sismember(ADHAM..':SUDO_BOT:',UserID) then
var = 'مطور البوت 👨🏽‍💻' 
elseif redis:sismember(ADHAM..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي👷🏽' 
elseif redis:sismember(ADHAM..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء 👷🏽' 
...
local list = redis:smembers(ADHAM..':SUDO_BOT:')
...
local monsha = redis:smembers(ADHAM..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
if redis:get(ADHAM..'group:add'..msg.chat_id_) then  return '🎗*│*المجموعه بالتأكيد ✓️ تم تفعيلها' end
...
if not redis:get(ADHAM..'group:add'..msg.chat_id_) then return '🛠*│* المجموعه بالتأكيد ✓️ تم تعطيلها' end  
...
if redis:sismember(ADHAM..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID,'username',Resolv)
redis:sadd(ADHAM..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(ADHAM..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(ADHAM..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(ADHAM..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(ADHAM..'username:'..UserID, 'username', Resolv)
redis:sadd(ADHAM..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(ADHAM..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(ADHAM..':SUDO_BOT:',UserID)
...
if cmd == "dn_sudo" then
if not redis:sismember(ADHAM..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'🙍🏻‍♂*╿*العضو » '..USERNAME..' \n🎫*│* الايدي » (`'..UserID..'`)\n💯*╽*انه بالتأكيد ليس مطور \n✓') end
redis:srem(ADHAM..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'🙍🏻‍♂╿العضو » ❪ '..USERNAME..' ❫\n🎫│الايدي » ❪ '..UserID..' ❫\n💯╽تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
.."\n⃣│التاك «» "..(redis:get(ADHAM..'lock_tag'..msg.chat_id_) or 'false')
...
.."\n⚜️│الماركدوان «» "..(redis:get(ADHAM..'lock_markdown'..msg.chat_id_) or 'false')
...
.."\n◽️│الانلاين «» "..(redis:get(ADHAM..'mute_inline'..msg.chat_id_) or 'false')
